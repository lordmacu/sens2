                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      Padding(
                          ...
                          DropdownText(
                            items: ['Proveedores 2', 'Item 2', 'Item 3']),
                            Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Align(
                            alignment: Alignment.centerLeft, 
                    ...
                    Container(
                      ...
                      child: TextButton(
                        ...
                        child: Text(
                          'Enviar',
                          style: TextStyle(color: Color.fromARGB(255, 129, 123, 68), fontSize: 17,),
                        ),
                        style: ButtonStyle(
                          backgroundColor: MaterialStateProperty.all<Color>(
                     ...
                     Container(
                      ...
                      child: TextButton(
                        ...
                        child: Text(
                          'Cerrar Lote',
                          style: TextStyle(color: const Color.fromARGB(255, 43, 41, 41), fontSize: 17),
                        ),
                        style: ButtonStyle(
                          backgroundColor: MaterialStateProperty.all<Color>(
