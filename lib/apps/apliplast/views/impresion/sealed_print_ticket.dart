...
class SealedPrintTicket extends StatelessWidget {
  // Registrar el controlador usando Get.put()
  final PrintTicketSealedController printTicketSealedController =
      Get.put(PrintTicketSealedController());
  ...
  SealedPrintTicket({super.key}); // Constructor
