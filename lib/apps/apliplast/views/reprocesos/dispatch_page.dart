...
class _DispatchPageState extends State<DispatchPage> {
  ...
  final List<Map<String, dynamic>> _pesos = <Map<String, dynamic>>[
              ...
              IconButton(
                ...
                onPressed: () {
                  Navigator.of(context)
                      .pop(); // Usar Navigator.of(context).pop() para cerrar el diálogo
                },
              ),
            ],
          ),
  ...
  void _deletePeso(int id) {
    ...
    _showPopup(context); // Mostrar el popup nuevamente después de borrar
  }
